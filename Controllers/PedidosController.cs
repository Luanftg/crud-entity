...
namespace crud_entity.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CarroId,ClienteId,DataLocacao,DataEntrega")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CarroId,ClienteId,DataLocacao,DataEntrega")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
